...
block1 = residual_module(inner_model_input, 32) # (16, 16, 16)
block1 = residual_module(block1, 32)
block1 = residual_module(block1, 32)
block1 = residual_module(block1, 32)
block2 = keras.layers.MaxPooling3D(pool_size=2)(block1) # (8, 8, 8)
block2 = residual_module(block2, 64)
block2 = residual_module(block2, 64)
block2 = residual_module(block2, 64)
block2 = residual_module(block2, 64)
block3 = keras.layers.MaxPooling3D(pool_size=2)(block2) # (4, 4, 4)
block3 = residual_module(block3, 128)
block3 = residual_module(block3, 128)
block3 = residual_module(block3, 128)
block3 = residual_module(block3, 128)
block4 = keras.layers.MaxPooling3D(pool_size=2)(block3) # (2, 2, 2)
block4 = residual_module(block4, 256)
block4 = residual_module(block4, 256)
flatten = keras.layers.MaxPooling3D(pool_size=(1, 2, 2))(block4) # (1, 1, 1)
...
fc = keras.layers.Dense(128  , kernel_initializer=uni_init, activation='linear')(fc)
